{% macro init_s3_sources() -%}
    ...
    {% set sql %}
        ...
        CREATE TABLE db1.src_lineorder
        (
            LO_ORDERKEY             UInt32,
            LO_LINENUMBER           UInt8,
            LO_CUSTKEY              UInt32,
    ...
    {% set list_of_sql = sql.split(';') %}
    
    {% for query in list_of_sql %}
